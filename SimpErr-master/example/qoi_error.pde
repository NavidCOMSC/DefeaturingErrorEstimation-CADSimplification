...
numproc rhs calc_l -defeatured=phibar -bfdf=abar -lin=l -feature=2 -verbose
...
# sets Dirichlet boundary values
#numproc setvalues npsv -coefficient=coef_dirichlet_dual -gridfunction=phibar -boundary
...
# Estimate the energy in the interested domain
numproc qoi_error ene -defeatured=phibar -bfdf=abar -feature=2 -verbose
